...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            if (extra_turn(score0, score1) and score0 < goal and score1 < goal) == False:
                who = other(who)
        else:
            if (extra_turn(score1, score0) and score0 < goal and score1 < goal) == False:
                who = other(who)
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who:
            run_high = score1 - last_score
            if run_high > running_high:
                print(run_high, "point(s)! The most yet for Player", who)
                return announce_highest(who, score1, run_high)
            return announce_highest(who, score1, running_high)
        else:
            run_high = score0 - last_score
            if run_high > running_high:
                print(run_high, "point(s)! The most yet for Player", who)
                return announce_highest(who, score0, run_high)
